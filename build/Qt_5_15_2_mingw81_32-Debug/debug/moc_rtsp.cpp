...
QT_MOC_LITERAL(1, 5, 6), // "sigYuv"
QT_MOC_LITERAL(2, 12, 0), // ""
QT_MOC_LITERAL(3, 13, 6), // "uchar*"
QT_MOC_LITERAL(4, 20, 3), // "buf"
QT_MOC_LITERAL(5, 24, 5), // "width"
QT_MOC_LITERAL(6, 30, 6) // "height"

    },
    "Rtsp\0sigYuv\0\0uchar*\0buf\0width\0height"
};
...
void Rtsp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigYuv((*reinterpret_cast< uchar*(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2])),(*reinterpret_cast< uint(*)>(_a[3]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Rtsp::*)(uchar * , uint , uint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Rtsp::sigYuv)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Rtsp::sigYuv(uchar * _t1, uint _t2, uint _t3)
{
